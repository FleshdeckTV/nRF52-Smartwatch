...
uint8_t Adafruit_DRV2605::read_status() {
	uint8_t id = readRegister8(DRV2605_REG_STATUS);
  return id;
}

uint8_t Adafruit_DRV2605::auto_cal() {
  setMode(DRV2605_MODE_AUTOCAL);
  
  writeRegister8(DRV2605_REG_CLAMPV,
                 readRegister8(DRV2605_REG_CLAMPV) | 0x96);
				 
  writeRegister8(DRV2605_REG_CONTROL3, 0xA0);
  
  writeRegister8(DRV2605_REG_CONTROL4,
                 readRegister8(DRV2605_REG_CONTROL4) | 0x30);
